...
import { IPreview, WebViewConfHandler, WebViewConfHandlerEnum, Dto } from './types'

export class ViewLoader {
  public static currentPanel?: vscode.WebviewPanel
  static _style = conf.getConf().preview ?? DefaultConf.preview!
